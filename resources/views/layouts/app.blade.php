...
<head>
    ...
    <style>
        body{margin:0;background:#f4f7fa;color:#173a57;font-family:system-ui,sans-serif}.sidebar{position:fixed;inset:0 auto 0 0;width:248px;background:#063b63;padding:26px 14px;display:flex;flex-direction:column}.brand{color:#fff;font-weight:700;font-size:1.2rem}.nav-heading{font-size:.68rem;letter-spacing:.08em;color:#b5cedd;margin:25px 10px 8px}.side-link{display:flex;gap:11px;align-items:center;color:#d6e6f0;text-decoration:none;border-radius:5px;padding:10px 12px;font-size:.9rem;margin:2px 0}.side-link:hover,.side-link.active{color:#fff;background:#146495}.side-link i{width:17px}.sidebar-bottom{margin-top:auto;border-top:1px solid #6091ad;padding-top:14px}.profile{display:flex;gap:9px;align-items:center;color:#fff;font-size:.8rem;padding:8px}.avatar{background:#c7e6ef;color:#164c6d;width:29px;height:29px;border-radius:50%;display:grid;place-items:center;font-weight:bold;font-size:.7rem}.page{margin-left:248px;min-height:100vh}.topbar{height:78px;background:#fff;border-bottom:1px solid #e4eaf0;display:flex;align-items:center;justify-content:space-between;padding:0 34px}.breadcrumb-label{font-size:.76rem;font-weight:700;color:#31546e}.page-title{font-weight:700;font-size:1.2rem;margin:3px 0}.top-user{font-size:.8rem;color:#6f7f8e}.content{padding:28px 34px}.metric,.toolbar,.panel{background:#fff;border:1px solid #e4eaf0;border-radius:6px}.metric{padding:15px 16px;min-height:68px;display:flex;align-items:center;justify-content:space-between}.metric-label{font-size:.74rem;font-weight:700}.metric-value{font-size:1.35rem;font-weight:700}.toolbar{padding:14px;display:flex;gap:9px;align-items:center;flex-wrap:wrap}.panel{padding:18px}.asset-card{border:1px solid #e4eaf0;border-radius:5px;padding:13px;min-height:152px}.asset-card h3{font-size:.88rem;font-weight:700;margin:9px 0}.tiny{font-size:.72rem;color:#6f7f8e}.detail-row{font-size:.7rem;border-bottom:1px solid #edf1f4;padding:5px 0;display:flex;justify-content:space-between}.btn-outline-brand{border:2px solid #17618b;color:#174a6c;font-weight:700;font-size:.7rem;padding:4px;width:100%;margin-top:10px}.map-area{height:520px;position:relative;overflow:hidden;background:repeating-linear-gradient(35deg,#e6ecef 0 34px,#dce5e8 35px 68px)}.map-pin{position:absolute;background:#fff;border-radius:4px;box-shadow:0 2px 6px #7894a477;padding:4px 7px;font-size:.68rem;font-weight:700}.map-card{position:absolute;right:8%;top:21%;width:235px;background:#fff;border:1px solid #dfe5e9;border-radius:5px;padding:13px;box-shadow:0 5px 12px #607b8a2b}.table{font-size:.8rem}.table thead th{font-size:.68rem;text-transform:uppercase;color:#6f7f8e}.form-label{font-size:.78rem;font-weight:700;color:#35566e}.form-control,.form-select{font-size:.82rem;border-color:#d9e2e9}.btn-brand{background:#0b5f8b;border-color:#0b5f8b;color:#fff}.btn-brand:hover{background:#084d72;color:#fff}
    </style>
</head>
<body>
<aside class="sidebar">
